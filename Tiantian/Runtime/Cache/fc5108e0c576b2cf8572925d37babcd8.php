...
<?php endif; ?>
  ...
  <div class="span10">
    ...
    <div class="row">
      <form class="form-horizontal" id="eventForm" action="<?php echo U('EventCreate/offlineEventInfoSave',array('id'=>$id));?>" method="POST">
...
$(function () { 
  var category_select = {
    ...
    preselect: { 'category_select' : [ '<?php echo ($event_category); ?>' , '<?php echo ($event_sub_category); ?>' ]},
  ...
  var location_options = {
    ...
    preselect: { 'location_select' : [ '<?php echo ($province); ?>' , '<?php echo ($city); ?>' , '<?php echo ($area); ?>' ]},
    preselect_only_once: true, 
    loading_image:'__PUBLIC__/img/loading.gif',
    select_class:'span2',
    get_parent_value_if_empty: true,
