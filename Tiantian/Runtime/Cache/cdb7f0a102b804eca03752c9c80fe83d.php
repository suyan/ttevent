...
<div class="span10">
  <table class="table table-bordered">
    <thead>
      <tr><th>序号</th><th>头像</th><th>昵称</th><th>参加时间</th><th>状态</th></tr>
    </thead>
    <tbody>
      <?php if(is_array($follows)): $i = 0; $__LIST__ = $follows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$follow): $mod = ($i % 2 );++$i;?><tr><td class="hide"><?php echo ($follow['id']); ?></td><td><?php echo ($key+1); ?></td><td><img class="middle_avatar" src="__PUBLIC__/avatar/<?php echo ($follow['user']['small_img']); ?>" alt=""></td><td><?php echo ($follow['user']['nickname']); ?></td><td><?php echo date('Y-m-d G:i',$follow['create_time']);?></td><td>已关注</td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
    </tbody>
  </table>
</div>
