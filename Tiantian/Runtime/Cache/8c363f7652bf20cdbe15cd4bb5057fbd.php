      ...
      <div class="control-group">
        ...
        <div class="controls">
          ...
          <label class="radio inline disabled">
            <input type="radio" id="online" value="1" disabled>
            线上活动<span class="text-error">(赞不支持)</span>
          </label>
        </div>
      </div>
      <div class="control-group">
        <div class="controls">
          <button id="submit" class="btn btn-primary">下一步</button>
        </div>
      </div>
    </div>
  </div>
...
$('#submit').bind('click',function(){
  if($("#offline").attr('checked'))
    window.location.href = '<?php echo U("EventCreate/offlineEventInfo");?>';
  else
    window.location.href = '<?php echo U("EventCreate/onlineEventInfo");?>';
});
</script>
